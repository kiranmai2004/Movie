...
fetch('http://www.omdbapi.com/?i=tt3896198&apikey=78004167')
    .then(res => res.json())
        ...
        <div class="fav-item">
            ...
            <div class="fav-details">
                <div class="fav-details-box">
                    <div>
                        <p class="fav-movie-name"><a href="movie?id=${id}">${i.Title}</a></p>
                        <p class="fav-movie-rating"><a href="movie?id=${id}">${i.Year}</a></p>
                    </div>
                    <div>
